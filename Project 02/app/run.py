...
# use either this import or just joblib
...
def index():
    ...
    original_counts = [df.original.isna().sum(), df.shape[0]]
    ...
    graphs = [
        {
            ...
            'layout': {
                'title': 'Distribution of Messages with original texts provided',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
        ...
        },
        {
            ...
            'layout': {
                'title': 'Top 3 categories in training dataset',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
